...
$form = array(
	'subject' => 'Отправка Форма changepass',
	...
	'fields' => array(
		'custom_U175315' => array(
			'order' => 1,
			'type' => 'string',
			'label' => 'Код підтвердження',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Код підтвердження\' не может быть пустым.'
			)
		),
		'custom_U175327' => array(
			'order' => 2,
			'type' => 'string',
			'label' => 'Новий пароль',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Новий пароль\' не может быть пустым.'
			)
		),
		'custom_U175339' => array(
			'order' => 3,
			'type' => 'string',
