...
<!---->
<?//= $form->field($res_model,'email')->textInput()->label('Електронна пошта')?>
<!---->
<!--<div>-->
...
<?php //$form = ActiveForm::begin();?>
<!---->
<?//= $form->field($login_model,'email')->textInput()->label('Електронна пошта')?>
<!---->
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="site-login">
                ...
                <?= $form->field($res_model,'email')->textInput(['autofocus' => true])->textInput()->label('Електронна пошта')?>
