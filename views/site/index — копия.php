...
<head>
    ...
    <title>gallery</title>
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="../web/css/site_global.css"/>
    <link rel="stylesheet" type="text/css" href="../web/css/master_______-a.css"/>
    <link rel="stylesheet" type="text/css" href="../web/css/index.css" id="pagesheet"/>
    <link rel="stylesheet" type="text/css" href="../web/css/pagination.css"/>
    <!-- IE-only CSS -->
    <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="../web/css/nomq_preview_master_______-a.css"/>
    <link rel="stylesheet" type="text/css" href="../web/css/nomq_index.css" id="nomq_pagesheet"/>
    <![endif]-->
    <!-- JS includes -->
    <!--[if lt IE 9]>
    <script src="../web/scripts/html5shiv.js" type="text/javascript"></script>
    <![endif]-->
</head>
...
<div class="breakpoint active" id="bp_infinity" data-min-width="1141"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox" id="page"><!-- column -->
        ...
        <div class="clearfix colelem" id="pu181623"><!-- group -->
            <?php  use yii\widgets\ActiveForm;
            $form=ActiveForm::begin(); ?>
            <div class="grpelem shared_content" id="u181623" data-content-guid="u181623_content"><!-- simple frame --></div>
            ...
            <div class="clearfix grpelem shared_content" id="u9868-4" data-content-guid="u9868-4_content"><!-- content -->
                <p id="u9868-2"><span id="u9868">Категорія:</span></p>
            </div>
            ...
            <div class="grpelem shared_content" id="u55851" data-content-guid="u55851_content"><!-- custom html -->
                <?= $form->field($sort, 'category')->dropDownList([
                    '0'=>'Ню',
                    '1'=>'Натюрморт',
                    '2'=>'Портрет',
                    '3'=>'Пейзаж',
                    ...
                    '7'=>'Інтер\'єр',
                    '8'=>'Карикатура'],
                    $params = ['prompt' => 'Оберіть категорію']
                )->label(false); ?>
            </div>

            <!--            <div class="grpelem shared_content" id="u62695" data-content-guid="u62695_content">-->
            <!--                <form>-->
            ...
            <!--            <div class="grpelem shared_content" id="u55851" data-content-guid="u55851_content">-->
            <!--                <form>-->
            ...
            <!--                        <option>Алегорія</option>-->
            <!--                        <option>Побутовий</option>-->
            <!--                        <option>Інтер'єр</option>-->
            <!--                        <option>Карикатура</option>-->
            <!--                        <option>Ню</option>-->
            <!--                    </select>-->
            <!--                </form>-->
            <!--            </div>-->
            ...
            <div class="grpelem shared_content" id="u62695" data-content-guid="u62695_content">
                <?= $form->field($sort, 'sort')->dropDownList([
                    '0'=>'Спочатку найновіші',
                    '1'=>'Найпопулярніші',
                    '2'=>'Спочатку найдешевші',
                    '3'=>'Спочатку найдорожчі'],
                    $params = ['options' => ['0'=>['Selected'=>true]]]
                )->label(false); ?>
            </div>
            <!--            --><?php //   ActiveForm::end(); ?>
            ...
            <div class="grpelem shared_content" id="u69187" data-content-guid="u69187_content"><!-- custom html -->
                ...
                <?= $form->field($sort, 'priceFrom')->textInput(['class'=>'raz', 'id'=>'dva', 'value'=>'0', 'type'=>'number'])->label(false); ?>
            ...
            <div class="grpelem shared_content" id="u72431" data-content-guid="u72431_content"><!-- custom html -->
                ...
                <?= $form->field($sort, 'priceTo')->textInput(['class'=>'raz', 'id'=>'dva', 'value'=>'99999'])->label(false); ?>

            </div>
            <!--            <div class="transition rounded-corners clearfix grpelem shared_content" id="u72436-4" data-content-guid="u72436-4_content">-->
            <!--                <p id="u72436-2">Сотувати</p>-->
            <!--            </div>-->


            <button class="transition rounded-corners clearfix grpelem shared_content" id="u72436-4" type="submit" value="Сотувати" data-content-guid="u72436-4_content"><!-- content -->
                <p id="u72436-2">Сотувати</p>
            </button>
        ...
        <div class="clearfix colelem" id="pu179989"><!-- group -->
            <div class="rounded-corners clearfix grpelem" id="u179989"><!-- column -->
                <div class="clearfix colelem shared_content" id="u180440-4" data-content-guid="u180440-4_content"><!-- content -->
                    <p id="u180440-2">ТОП - Картини</p>
                </div>
                <?php use yii\helpers\Url;
                use yii\widgets\LinkPager;

                foreach ($articles as $article): ?>
                    <div class="clearfix colelem" id="u180019"><!-- group -->
                        <div class="grpelem shared_content" id="u180020" data-content-guid="u180020_content"><!-- custom html -->
                            <hr>
                        </div>
                        <div class="clearfix grpelem shared_content" id="u180036" data-content-guid="u180036_content"><!-- column -->
                            <div class="clearfix colelem shared_content" id="pu180037-4" data-content-guid="pu180037-4_content"><!-- group -->
                                <div class="clearfix grpelem shared_content" id="u180037-4" data-content-guid="u180037-4_content"><!-- content -->
                                    <p id="u180037-2"><?=$article->title; ?></p>
                                </div>
                                <div class="clearfix grpelem shared_content" id="u180034-4" data-content-guid="u180034-4_content"><!-- content -->
                                    <p id="u180034-2"><?=$article->price ?></p>
                                </div>
                                <div class="clearfix grpelem shared_content" id="u180033-4" data-content-guid="u180033-4_content"><!-- content -->
                                    <p id="u180033-2">₴</p>
                                </div>
                            </div>
                            <div class="clearfix colelem shared_content" id="pu180473-4" data-content-guid="pu180473-4_content"><!-- group -->
                                <div class="clearfix grpelem" id="u180473-4"><!-- content -->
                                    <p id="u180473-2">Автор:</p>
                                </div>
                                <div class="clearfix grpelem" id="u180503-4"><!-- content -->
                                    <p id="u180503-2"><?=$article->description ?></p>
                                </div>
                            </div>
                            <div class="clearfix colelem shared_content" id="pu180563-4" data-content-guid="pu180563-4_content"><!-- group -->
                                <div class="clearfix grpelem" id="u180563-4"><!-- content -->
                                    <p id="u180563-2">Жанр:</p>
                                </div>
                                <div class="clearfix grpelem" id="u180533-4"><!-- content -->
                                    <p id="u180533-2"><?= $article->category->title; ?></p>
                                </div>
                            </div>
                            <a class="nonblock nontext transition rounded-corners clearfix colelem shared_content" id="u180035-4" href="<?= Url::toRoute(['site/view', 'id'=>$article->id])?>" data-content-guid="u180035-4_content"><!-- content --><p id="u180035-2">Детальніше</p></a>
                        </div>
                        <div class="PamphletWidget clearfix widget_invisible grpelem" id="pamphletu180021"><!-- none box -->
                            <div class="ThumbGroup clearfix grpelem" id="u180022"><!-- none box -->
                                <div class="popup_anchor" id="u180023popup">
                                    <div class="Thumb popup_element clearfix" id="u180023"><!-- group -->
                                        <div class="clip_frame grpelem" id="u180024"><!-- image -->
                                            <img class="block temp_no_img_src" id="u180024_img" data-orig-src="<?= $article->getImage();?>" alt="" width="695" height="391" href="<?= Url::toRoute(['site/view', 'id'=>$article->id])?>" data-image-width="695" data-image-height="391" src="<?= $article->getImage();?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="rounded-corners clearfix grpelem" id="u13384"><!-- column -->
                ...
                <?php foreach ($popular as $article):?>
                    <div class="clearfix colelem" id="u177640"><!-- group -->
                        <div class="grpelem shared_content" id="u11266" data-content-guid="u11266_content"><!-- custom html -->
                            <hr>
                        </div>
                        <div class="clearfix grpelem shared_content" id="u177382" data-content-guid="u177382_content"><!-- column -->
                            <div class="clearfix colelem" id="u120415-4"><!-- content -->
                                <p id="u120415-2"><?= $article->title;?></p>
                            </div>
                            <div class="clearfix colelem" id="pu11185-4"><!-- group -->
                                <div class="clearfix grpelem" id="u11185-4"><!-- content -->
                                    <p id="u11185-2"><?= $article->price;?></p>
                                </div>
                                <div class="clearfix grpelem" id="u11215-4"><!-- content -->
                                    <p id="u11215-2">₴</p>
                                </div>
                                <a class="nonblock nontext transition rounded-corners clearfix grpelem" id="u13861-4" href="<?=Url::toRoute(['site/view', 'id'=>$article->id]);?>"><!-- content --><p id="u13861-2">Детальніше</p></a>
                            </div>
                        </div>
                            ...
                            <div class="ThumbGroup clearfix grpelem" id="u126000"><!-- none box -->
                                <div class="popup_anchor" id="u126001popup">
                                    <div class="Thumb popup_element clearfix" id="u126001"><!-- group -->
                                        <div class="clip_frame grpelem" id="u126002"><!-- image -->
                                            <img class="block temp_no_img_src" id="u126002_img" data-orig-src="<?= $article->getImage();?>" href="<?=Url::toRoute(['site/view', 'id'=>$article->id]);?>" height="183" width="326" alt="" data-image-width="326" data-image-height="183" src="<?= $article->getImage();?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="verticalspacer" data-offset-top="1200" data-content-above-spacer="1200" data-content-below-spacer="661"></div>
    ...
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
        ...
        <div class="clearfix colelem" id="pu13384"><!-- group -->
            <div class="rounded-corners clearfix grpelem temp_no_id" data-orig-id="u13384"><!-- column -->
                ...
                <div class="clearfix colelem temp_no_id" data-orig-id="u177640"><!-- group -->
                    <span class="grpelem placeholder" data-placeholder-for="u11266_content"><!-- placeholder node --></span>
                    <span class="clearfix grpelem placeholder" data-placeholder-for="u177382_content"><!-- placeholder node --></span>
                            ...
                            <div class="popup_anchor temp_no_id" data-orig-id="u126001popup">
                                <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u126001"><!-- group -->
                                    <div class="clip_frame grpelem temp_no_id" data-orig-id="u126002"><!-- image -->
                                        <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default299x168.png?crc=465147560" alt="" data-image-width="299" data-image-height="168" data-orig-id="u126002_img" src="../web/images/blank.gif?crc=4208392903"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="popup_anchor temp_no_id" data-orig-id="u126005popup">
                            <div class="ContainerGroup rgba-background clearfix temp_no_id" data-orig-id="u126005"><!-- stack box -->
                                <div class="Container clearfix grpelem temp_no_id" data-orig-id="u126006"><!-- group -->
                                    <span class="clip_frame grpelem placeholder" data-placeholder-for="u126007_content"><!-- placeholder node --></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="rounded-corners clearfix grpelem temp_no_id" data-orig-id="u179989"><!-- column -->
                <span class="clearfix colelem placeholder" data-placeholder-for="u180440-4_content"><!-- placeholder node --></span>
                <div class="clearfix colelem temp_no_id" data-orig-id="u180019"><!-- group -->
                    <span class="grpelem placeholder" data-placeholder-for="u180020_content"><!-- placeholder node --></span>
                    <span class="clearfix grpelem placeholder" data-placeholder-for="u180036_content"><!-- placeholder node --></span>
                    <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                        <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                            <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                                <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                    <div class="clip_frame grpelem temp_no_id" data-orig-id="u180024"><!-- image -->
                                        <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default634x357.png?crc=29014742" alt="" data-image-width="634" data-image-height="357" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="popup_anchor temp_no_id" data-orig-id="u180029popup">
                            <div class="ContainerGroup rgba-background clearfix temp_no_id" data-orig-id="u180029"><!-- stack box -->
                                <div class="Container clearfix grpelem temp_no_id" data-orig-id="u180030"><!-- group -->
                                    <span class="clip_frame grpelem placeholder" data-placeholder-for="u180031_content"><!-- placeholder node --></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <span class="grpelem placeholder" data-placeholder-for="u181623_content"><!-- placeholder node --></span>
        ...
        <div class="verticalspacer" data-offset-top="1200" data-content-above-spacer="1200" data-content-below-spacer="426"></div>
...
<div class="breakpoint" id="bp_960" data-min-width="801" data-max-width="960"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
        ...
        <span class="colelem placeholder" data-placeholder-for="u9680_content"><!-- placeholder node --></span>
        <span class="clearfix colelem placeholder" data-placeholder-for="u9730-4_content"><!-- placeholder node --></span>
        <div class="clearfix colelem temp_no_id" data-orig-id="pu13384"><!-- group -->
            <div class="rounded-corners clearfix grpelem temp_no_id" data-orig-id="u13384"><!-- column -->
                <span class="clearfix colelem placeholder" data-placeholder-for="u11149-4_content"><!-- placeholder node --></span>
                <div class="clearfix colelem temp_no_id" data-orig-id="u177640"><!-- group -->
                    <span class="grpelem placeholder" data-placeholder-for="u11266_content"><!-- placeholder node --></span>
                    ...
                    <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu125998"><!-- none box -->
                        <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u126000"><!-- none box -->
                            <div class="popup_anchor temp_no_id" data-orig-id="u126001popup">
                                <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u126001"><!-- group -->
                                    <div class="clip_frame grpelem temp_no_id" data-orig-id="u126002"><!-- image -->
                                        <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default249x140.png?crc=4028722453" alt="" data-image-width="249" data-image-height="140" data-orig-id="u126002_img" src="../web/images/blank.gif?crc=4208392903"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="clearfix colelem temp_no_id" data-orig-id="u180019"><!-- group -->
                    ...
                    <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                        <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                            <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                                <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                    <div class="clip_frame grpelem temp_no_id shared_content" data-orig-id="u180024" data-content-guid="u180024_content"><!-- image -->
                                        <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default538x303.png?crc=4067482901" alt="" data-image-width="538" data-image-height="303" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="verticalspacer" data-offset-top="1163" data-content-above-spacer="1163" data-content-below-spacer="463"></div>
        <div class="browser_width colelem temp_no_id" data-orig-id="u31041-bw">
            <div class="temp_no_id" data-orig-id="u31041"><!-- column -->
                <div class="clearfix temp_no_id" data-orig-id="u31041_align_to_page">
                    <div class="clearfix colelem temp_no_id" data-orig-id="pu32840"><!-- group -->
...
<div class="breakpoint" id="bp_800" data-min-width="721" data-max-width="800"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
        ...
        <div class="clearfix colelem temp_no_id" data-orig-id="pu181623"><!-- group -->
            <span class="grpelem placeholder" data-placeholder-for="u181623_content"><!-- placeholder node --></span>
            <span class="clearfix grpelem placeholder" data-placeholder-for="u9868-4_content"><!-- placeholder node --></span>
            <span class="clearfix grpelem placeholder" data-placeholder-for="u9928-4_content"><!-- placeholder node --></span>
            <span class="grpelem placeholder" data-placeholder-for="u55851_content"><!-- placeholder node --></span>
        ...
        <div class="rounded-corners clearfix colelem temp_no_id" data-orig-id="u179989"><!-- column -->
            <span class="clearfix colelem placeholder" data-placeholder-for="u180440-4_content"><!-- placeholder node --></span>
            <div class="clearfix colelem temp_no_id" data-orig-id="u180019"><!-- group -->
                <span class="grpelem placeholder" data-placeholder-for="u180020_content"><!-- placeholder node --></span>
                <span class="clearfix grpelem placeholder" data-placeholder-for="u180036_content"><!-- placeholder node --></span>
                <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                    <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                        <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                            <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                <span class="clip_frame grpelem placeholder" data-placeholder-for="u180024_content"><!-- placeholder node --></span>
                            </div>
                        </div>
                    </div>
                    <div class="popup_anchor temp_no_id" data-orig-id="u180029popup">
        ...
        <div class="verticalspacer shared_content" data-offset-top="1227" data-content-above-spacer="1226" data-content-below-spacer="400" data-content-guid="page_7_content"></div>
        <div class="browser_width colelem temp_no_id" data-orig-id="u31041-bw">
            <div class="temp_no_id" data-orig-id="u31041"><!-- column -->
                <div class="clearfix temp_no_id" data-orig-id="u31041_align_to_page">
                    <div class="clearfix colelem temp_no_id" data-orig-id="pu32840"><!-- group -->
...
<div class="breakpoint" id="bp_480" data-min-width="415" data-max-width="480"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
                ...
                <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                    <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                        <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                            <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                <div class="clip_frame grpelem temp_no_id" data-orig-id="u180024"><!-- image -->
                                    <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default434x244.png?crc=4170735378" alt="" data-image-width="434" data-image-height="244" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="verticalspacer" data-offset-top="1108" data-content-above-spacer="1107" data-content-below-spacer="371"></div>
...
<div class="breakpoint" id="bp_414" data-min-width="376" data-max-width="414"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
                ...
                <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                    <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                        <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                            <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                <div class="clip_frame grpelem temp_no_id" data-orig-id="u180024"><!-- image -->
                                    <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default367x207.png?crc=3769637143" alt="" data-image-width="367" data-image-height="206" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="verticalspacer" data-offset-top="1036" data-content-above-spacer="1035" data-content-below-spacer="443"></div>
...
<div class="breakpoint" id="bp_375" data-min-width="321" data-max-width="375"><!-- responsive breakpoint node -->
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
        ...
        <div class="rounded-corners clearfix colelem temp_no_id" data-orig-id="u179989"><!-- column -->
            ...
            <div class="clearfix colelem temp_no_id" data-orig-id="u180019"><!-- group -->
                <span class="grpelem placeholder" data-placeholder-for="u180020_content"><!-- placeholder node --></span>
                <div class="clearfix grpelem temp_no_id" data-orig-id="u180036"><!-- column -->
                    <div class="position_content" id="u180036_position_content">
                        <span class="clearfix colelem placeholder" data-placeholder-for="pu180037-4_content"><!-- placeholder node --></span>
                        <span class="clearfix colelem placeholder" data-placeholder-for="pu180473-4_content"><!-- placeholder node --></span>
                        <span class="clearfix colelem placeholder" data-placeholder-for="pu180563-4_content"><!-- placeholder node --></span>
                        <span class="nonblock nontext transition rounded-corners clearfix colelem placeholder" data-placeholder-for="u180035-4_content"><!-- placeholder node --></span>
                    </div>
                </div>
                <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                    <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                        <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                            <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                <div class="clip_frame grpelem temp_no_id" data-orig-id="u180024"><!-- image -->
                                    <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default344x193.png?crc=4245689397" alt="" data-image-width="343" data-image-height="193" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="verticalspacer" data-offset-top="1037" data-content-above-spacer="1036" data-content-below-spacer="442"></div>
        <div class="browser_width colelem temp_no_id" data-orig-id="u31041-bw">
            <div class="temp_no_id" data-orig-id="u31041"><!-- column -->
                <div class="clearfix temp_no_id" data-orig-id="u31041_align_to_page">
                    <div class="clearfix colelem temp_no_id" data-orig-id="pu32840"><!-- group -->
    ...
    <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
        ...
        <div class="rounded-corners clearfix colelem temp_no_id" data-orig-id="u179989"><!-- column -->
            ...
            <div class="clearfix colelem temp_no_id" data-orig-id="u180019"><!-- group -->
                <span class="grpelem placeholder" data-placeholder-for="u180020_content"><!-- placeholder node --></span>
                <div class="clearfix grpelem temp_no_id" data-orig-id="u180036"><!-- column -->
                    <div class="position_content temp_no_id" data-orig-id="u180036_position_content">
                        <span class="clearfix colelem placeholder" data-placeholder-for="u180037-4_content"><!-- placeholder node --></span>
                        <span class="clearfix colelem placeholder" data-placeholder-for="pu180473-4_content"><!-- placeholder node --></span>
                        <span class="clearfix colelem placeholder" data-placeholder-for="pu180563-4_content"><!-- placeholder node --></span>
                        <div class="clearfix colelem" id="pu180034-4"><!-- group -->
                            <span class="clearfix grpelem placeholder" data-placeholder-for="u180034-4_content"><!-- placeholder node --></span>
                            <span class="clearfix grpelem placeholder" data-placeholder-for="u180033-4_content"><!-- placeholder node --></span>
                        </div>
                        <span class="nonblock nontext transition rounded-corners clearfix colelem placeholder" data-placeholder-for="u180035-4_content"><!-- placeholder node --></span>
                    </div>
                </div>
                <div class="PamphletWidget clearfix widget_invisible grpelem temp_no_id" data-orig-id="pamphletu180021"><!-- none box -->
                    <div class="ThumbGroup clearfix grpelem temp_no_id" data-orig-id="u180022"><!-- none box -->
                        <div class="popup_anchor temp_no_id" data-orig-id="u180023popup">
                            <div class="Thumb popup_element clearfix temp_no_id" data-orig-id="u180023"><!-- group -->
                                <div class="clip_frame grpelem temp_no_id" data-orig-id="u180024"><!-- image -->
                                    <img class="block temp_no_id temp_no_img_src" data-orig-src="../web/images/default309x174.png?crc=312925260" alt="" data-image-width="309" data-image-height="174" data-orig-id="u180024_img" src="../web/images/blank.gif?crc=4208392903"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="verticalspacer" data-offset-top="1007" data-content-above-spacer="1006" data-content-below-spacer="472"></div>
        <div class="browser_width colelem temp_no_id" data-orig-id="u31041-bw">
            <div class="temp_no_id" data-orig-id="u31041"><!-- column -->
                <div class="clearfix temp_no_id" data-orig-id="u31041_align_to_page">
                    <div class="clearfix colelem temp_no_id" data-orig-id="pu32840"><!-- group -->
...
<script type="text/javascript">
    ...
    var muse_init=function(){require.config({baseUrl:""});require(["jquery","museutils","whatinput","jquery.musemenu","jquery.watch","webpro","musewpslideshow","jquery.museoverlay","touchswipe","jquery.museresponsive"],function(d){var $ = d;$(document).ready(function(){try{
        ...
        Muse.Utils.initWidget('#pamphletu180021', ['#bp_infinity', '#bp_1140', '#bp_960', '#bp_800', '#bp_720', '#bp_640', '#bp_480', '#bp_414', '#bp_375', '#bp_320'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'lightbox',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu180021 */
...
<!-- RequireJS script -->
<script src="../web/scripts/require.js" type="text/javascript" async data-main="../web/scripts/museconfig.js" onload="if (requirejs) requirejs.onError = function(requireType, requireModule) { if (requireType && requireType.toString && requireType.toString().indexOf && 0 <= requireType.toString().indexOf('#scripterror')) window.Muse.assets.check(); }" onerror="window.Muse.assets.check();"></script>
</body>
</html>
