...
$form = array(
	...
	'fields' => array(
		'custom_U181673' => array(
			'order' => 1,
			'type' => 'string',
			'label' => 'Назва картини',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Назва картини\' не может быть пустым.'
			)
		),
		'custom_U181669' => array(
			'order' => 2,
			'type' => 'string',
			'label' => 'Автор',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Автор\' не может быть пустым.'
			)
		),
		'custom_U181660' => array(
			'order' => 3,
			'type' => 'string',
			'label' => 'Жанр',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Жанр\' не может быть пустым.'
			)
		),
		'custom_U181665' => array(
			'order' => 5,
			'type' => 'string',
			'label' => 'Ціна',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Ціна\' не может быть пустым.'
			)
		),
		'custom_U181684' => array(
			'order' => 4,
			'type' => 'string',
			'label' => 'Опис картини',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Опис картини\' не может быть пустым.'
			)
		)
	)
);
